...
function Registration() {
  ...
  const generatePassword = () => {
    ...
    // Fill the rest with random characters from all categories (total length: 12-16 characters)
    const allChars = uppercase + lowercase + numbers + symbols
    const remainingLength = Math.floor(Math.random() * 5) + 8 // 8-12 more characters
    ...
    // Reset the generated indicator after 3 seconds
    setTimeout(() => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] px-4 py-6 sm:px-6 lg:px-8">
      <div className="mb-4 text-center sm:mb-5">
        <img src="/logo.png" alt="1Move Logo" className="h-12 object-contain sm:h-14" />
      </div>

      <div className="w-full max-w-[440px] rounded-2xl bg-gradient-to-br from-[#1a1a1a] to-[#121212] px-6 py-6 shadow-[0_8px_32px_rgba(0,0,0,0.6)] sm:px-8 sm:py-7 lg:max-w-[900px]">
        <div className="mb-5 text-center sm:mb-6">
          <h1 className="mb-1.5 text-[1.5rem] font-semibold leading-snug text-white sm:text-[1.65rem]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-x-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-[#333333] bg-[#252525] px-4 py-3 text-[0.95rem] text-white transition-all duration-300 placeholder:text-[#666666] focus:border-gold focus:bg-[#2a2a2a] focus:shadow-[0_0_0_3px_rgba(196,165,114,0.1)] focus:outline-none"
              />
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="relative">
                <input
                  ...
                  } bg-[#252525] px-4 py-3 pr-12 text-[0.95rem] text-white transition-all duration-300 placeholder:text-[#666666] focus:bg-[#2a2a2a] focus:outline-none ${
                    errors.password
              ...
              {errors.password && (
                <span className="mt-1 block text-[0.8rem] leading-relaxed text-red-500">
                  {errors.password}
                </span>
              )}
              <div className="mt-1 flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 rounded-md px-2.5 py-1 text-xs font-medium transition-all duration-300 ${
                    passwordGenerated
            ...
            {/* Language */}
            <div>
              <label htmlFor="language" className="mb-1.5 block text-sm font-medium text-white">
                Language
              </label>
              <input
                type="text"
            ...
            {/* 1Move Link */}
            <div>
              <label htmlFor="onemove_link" className="mb-1.5 block text-sm font-medium text-white">
                1Move Link
              </label>
              <input
                type="url"
                ...
                } bg-[#252525] px-4 py-3 text-[0.95rem] text-white transition-all duration-300 placeholder:text-[#666666] focus:bg-[#2a2a2a] focus:outline-none ${
                  errors.onemove_link
                    ? 'focus:border-red-500 focus:shadow-[0_0_0_3px_rgba(231,76,60,0.1)]'
                    : 'focus:border-gold focus:shadow-[0_0_0_3px_rgba(196,165,114,0.1)]'
                }`}
            ...
            {/* PU Prime Link */}
            <div>
              <label htmlFor="puprime_link" className="mb-1.5 block text-sm font-medium text-white">
                PU Prime Link
              </label>
              <input
                type="url"
          ...
          <div className="mt-5">
            ...
            {errors.terms && (
              <span className="-mt-2 mb-3 block text-[0.8rem] leading-relaxed text-red-500">
                {errors.terms}
              </span>
            )}
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-gray-200 px-4 py-3.5 text-base font-semibold text-[#1a1a1a] transition-all duration-300 hover:-translate-y-0.5 hover:bg-white hover:shadow-[0_4px_12px_rgba(232,232,232,0.2)] active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60"
